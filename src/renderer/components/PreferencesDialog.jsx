...
export default function PreferencesDialog({ open, preferences, onChange, onClose, onOpenCheatsheet }) {
  ...
  return (
    <div className="dialog-backdrop" role="presentation" onClick={onClose}>
      <section className="preferences-dialog" role="dialog" aria-modal="true" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="preferences-dialog-body">
          ...
          <div className="preferences-layout">
            <PreferencesSection title="Appearance" caption="Tune the canvas and default reading width.">
              <label className="pref-row pref-row-stacked">
                <span className="pref-row-label">Default View</span>
              ...
              <label className="pref-row pref-row-stacked">
                <span className="pref-row-label">Font Size</span>
                <span className="pref-inline-control">
                  <input
                    type="range"
                    min="14"
                    max="24"
              ...
              <label className="pref-row pref-row-stacked">
                <span className="pref-row-label">Content Width</span>
                <span className="pref-inline-control">
                  <input
                    type="range"
                    min="720"
